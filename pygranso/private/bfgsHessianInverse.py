...
def bfgsHessianInverse(H, scaleH0):
    ...
    bfgsHessianInverse:
        ...
        bfgsHessianInverse.py (introduced in PyGRANSO v1.0.0)
        Copyright (C) 2016-2021 James Burke, Adrian Lewis, Tim Mitchell, and
        Michael Overton

        This is a direct port of bfgsHessianInverse.m from GRANSO v1.6.4.
